...
label = ctk.CTkLabel(frame , text = "حضور و غیاب" , font = ("B nazanin" , 22) , fg_color = "#2C669F" , text_color = "white" ,  corner_radius = 7)
...
theme_button = ctk.CTkButton(frame , text = "🌗" , font = ("B nazanin" , 20) , command = theme , width = 10)
...
def readf():
     ...
     if os.path.exists(f"{name_file}.txt"):
          ...
          read_label = ctk.CTkLabel(r , text = cf , font = ("B nazanin" , 15) , justify = "center" , anchor = "center" , wraplength = 650)
